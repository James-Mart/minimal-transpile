...
macro_rules! __export_world_example_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        export_hello() { unsafe { $($path_to_types)*:: _export_hello_cabi::<$ty > () } }
        };
    };
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:wasm:example:encoded world"
)]
#[doc(hidden)]
...
@\0\x01\0\x04\0\x05hello\x01\0\x04\0\x16component:wasm/example\x04\0\x0b\x0d\x01\
